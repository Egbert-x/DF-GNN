...
ENCODER_DEFAULT_LR = {
    ...
    'medqa_usmle': {
        ...
        # 'michiyasunaga/BioLinkBERT-base': 5e-5,
        'michiyasunaga/BioLinkBERT-large': 5e-5
    },
    'medqa': {
        # 'cambridgeltl/SapBERT-from-PubMedBERT-fulltext': 5e-5,
        # 'michiyasunaga/BioLinkBERT-base': 5e-5,
...
def add_data_arguments(parser):
    ...
    # statements
    parser.add_argument('--train_statements', default='../qagnn/{data_dir}/{dataset}/statement/train.statement_new.jsonl')
    parser.add_argument('--dev_statements', default='../qagnn/{data_dir}/{dataset}/statement/dev.statement_new.jsonl')
    parser.add_argument('--test_statements', default='../qagnn/{data_dir}/{dataset}/statement/test.statement_new.jsonl')
